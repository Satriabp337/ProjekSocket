...
public class ClientMain extends JFrame {
    ...
    // ... showConnectDialog, onConnectButtonClick, dan semua method callback (displayMessage, logMessage, dll.) ...
    ...
    /**
     * Menampilkan pesan di area chat/log. Aman dipanggil dari ClientService (sudah di-invokeLater).
     */
    ...
    /**
     * Dipanggil saat koneksi terputus secara tak terduga (IOException/SocketException).
     */
    ...
    private void showConnectDialog() {
        String usernameInput = JOptionPane.showInputDialog(this, "Masukkan Username:", "Koneksi", JOptionPane.PLAIN_MESSAGE);
